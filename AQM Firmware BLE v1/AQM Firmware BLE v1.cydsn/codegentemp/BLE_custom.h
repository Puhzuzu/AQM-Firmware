...
#define CYBLE_AIR_QUALITY_DATA_SERVICE_INDEX   (0x00u) /* Index of Air Quality Data service in the cyBle_customs array */
#define CYBLE_AIR_QUALITY_DATA_AIR_QUALITY_DATA_CHAR_INDEX   (0x00u) /* Index of Air Quality Data characteristic */
#define CYBLE_AIR_QUALITY_DATA_AIR_QUALITY_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_AIR_QUALITY_DATA_AIR_QUALITY_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */

#define CYBLE_AIR_QUALITY_DATA_SERVICE_HANDLE   (0x000Cu) /* Handle of Air Quality Data service */
#define CYBLE_AIR_QUALITY_DATA_AIR_QUALITY_DATA_CHAR_HANDLE   (0x000Eu) /* Handle of Air Quality Data characteristic */
#define CYBLE_AIR_QUALITY_DATA_AIR_QUALITY_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_AIR_QUALITY_DATA_AIR_QUALITY_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
